...
describe("AppServices", () => {
  it("exposes a shelves service", () => {
    const repositories: AppRepositories = {
      ...
      follows: { follow: vi.fn(), unfollow: vi.fn(), findFollow: vi.fn(), listFollowers: vi.fn(), listFollowing: vi.fn(), isMutual: vi.fn(), getViewerContext: vi.fn() },
      blocks: { block: vi.fn(), unblock: vi.fn(), findBlock: vi.fn(), listBlockedByUser: vi.fn(), isBlocked: vi.fn() },
      blockFilter: { removeBlocked: vi.fn(), isBlocked: vi.fn() },
