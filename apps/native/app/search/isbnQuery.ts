/**
 * Helpers used by the native /search input to decide whether the current
 * query looks like an ISBN lookup (`catalog.byIsbn`) or a free-text
 * title/author search (`catalog.search`).
 *
 * Native parity for `apps/web/app/search/isbnQuery.ts` (G-02, #76). Kept
 * as a pure module (no React Native imports) so it can be unit-tested
 * deterministically under the vitest Node environment.
 *
