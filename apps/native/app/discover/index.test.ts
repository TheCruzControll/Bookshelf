...
describe("Native Discover screen (P-07, #143)", () => {
  ...
  it("renders a list of recommendations when the fetcher returns them", () => {
  ...
  it("renders cold-start labels alongside main-pipeline labels in the same grid", () => {
