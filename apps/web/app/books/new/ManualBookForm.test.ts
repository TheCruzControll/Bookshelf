...
const { validateIsbn, validateYear, validateCoverUrl } = __testing;
...
describe("ManualBookForm contract (G-05, #79)", () => {
  ...
  it("ManualBookSubmission matches BooksCreateManualInput exactly", () => {
    // This is a compile-time contract: if the type drifts, the cast fails.
...
describe("validateManualBookState (G-05, #79 — client validation)", () => {
